...
class Doctor(models.Model):
    ...
    display_order = models.PositiveIntegerField(
        ...
        default=0,
        db_index=True,
        help_text=_('Klinikadagi ko‘rinish tartibi')
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['clinic', 'display_order']),
    ...
    def save(self, *args, **kwargs):
        ...
        if self.clinic_id and (not self.display_order or previous_clinic_id != self.clinic_id):
            max_order = (
                Doctor.objects.filter(clinic_id=self.clinic_id)
                .exclude(pk=self.pk)
            ...
            if max_order is None:
                max_order = 0
            if not self.display_order or previous_clinic_id != self.clinic_id:
