...
export const authApi = {
  ...
  patientPasswordResetRequest: (phone_number) => api.post('/users/password-reset/request/', { phone_number }),
  patientPasswordResetVerify: (phone_number, code) => api.post('/users/password-reset/verify/', { phone_number, code }),
