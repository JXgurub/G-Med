...
const ClinicOwnerDashboard = () => {
  ...
  const [reorderingDoctorId, setReorderingDoctorId] = useState(null)
  ...
  const handleReorderDoctor = async (doctorId, direction) => {
    if (!clinicOwner?.id) return
    try {
      setReorderingDoctorId(doctorId)
      await reorderDoctor(clinicOwner.id, doctorId, direction)
    } catch (error) {
      alert(error?.message || 'Doktor tartibini yangilashda xatolik yuz berdi')
    } finally {
      setReorderingDoctorId(null)
    }
  }
              ...
              <section className="dashboard-section">
                ...
                <div className="doctors-list">
                  {doctorsListForView.length > 0 ? (
                    doctorsListForView.map((doctor, index) => {
                      ...
                      const canMoveUp = activeView !== 'former-doctors' && index > 0
                      const canMoveDown = activeView !== 'former-doctors' && index < doctorsListForView.length - 1
                          ...
                          <div className="doctor-active-header">
                            ...
                            <div className="doctor-actions doctor-active-actions">
                              <button
                                ...
                                disabled={!canMoveUp || reorderingDoctorId === doctor.id}
                              ...
                              <button
                                ...
                                disabled={!canMoveDown || reorderingDoctorId === doctor.id}
